...
- I'm releasing some libraries or utilities for [SoLiD (Social Linked Data)](https://solidproject.org/), as needed by myself.
  - SoLid is [Tim Berners-Lee](https://en.wikipedia.org/wiki/Tim_Berners-Lee)'s fix for re-decentralizing the WWW; Web 3.0 for W3C (no, it's NOT Web3 in terms of blockchain; also see [my blog post (in Chinese)](https://blog.ryey.icu/on-web-3-0-and-web-3.html)).
